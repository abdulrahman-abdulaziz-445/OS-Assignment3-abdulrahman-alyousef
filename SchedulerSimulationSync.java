...
// task 1 & 2: Import synchronization classes
...
class SharedResources {
    ...
    public static final ReentrantLock lock = new ReentrantLock(); //task 1: single lock for all shared resources (simpler but less efficient)
    
    // TODO #2: Add a Semaphore to limit concurrent process execution
    public static final Semaphore cpuSemaphore = new Semaphore(1);
    //public static final Semaphore cpuSemaphore = new Semaphore(1); //task 2: semaphore to limit concurrent process execution
...
class Process implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println(Colors.BRIGHT_GREEN + "  ▶ " + name + " (Priority: " + priority + ") executing quantum [" + runTime + "ms]" + Colors.RESET);
            ...
            try {
                ...
                for (int i = 1; i <= steps; i++) {
                    ...
                    System.out.print("\r  " + Colors.YELLOW + "⚡" + Colors.RESET + " Quantum progress: " + quantumBar);
                }
                System.out.println();
            ...
            System.out.println(Colors.YELLOW + "  ⏸ " + Colors.CYAN + name + Colors.RESET + " completed quantum " + Colors.BRIGHT_YELLOW + runTime + "ms" + Colors.RESET);
